...
from .serializers import UserSerializer, ClienteSerializer, PedidoSerializer, EnvioSerializer, CategoriaSerializer, FornecedorSerializer, ProdutoSerializer, ItemPedidoSerializer
