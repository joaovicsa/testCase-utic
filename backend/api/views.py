...
from .serializers import UserSerializer, ClienteSerializer, PedidoSerializer, EnvioSerializer, CategoriaSerializer, FornecedorSerializer, ProdutoSerializer, ItemPedidoSerializer, MetodoPagamentoSerializer, PagamentoSerializer, AvaliacaoSerializer
...
class AvaliacaoListCreate(generics.ListCreateAPIView):
    serializer_class = AvaliacaoSerializer
    permission_classes = [IsAuthenticated]

    def get_queryset(self):
        user = self.request.user
        return Avaliacao.objects.filter(author=user)
